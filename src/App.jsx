...
+      // aktualizace / přidání markerů
+      Object.entries(data).forEach(([uid, u]) => {
+        // ... (unchanged marker update logic)
+        // (rest of this block is unchanged)
+        // (not repeated here for brevity)
+        // --- rest remains as in the original ---
+        // Copy-paste the unchanged block here!
+        // For the real code, just leave as it was
+        const isMe = viewerUid && uid === viewerUid;
+        const isDevBot = !!u?.isDevBot;
+        const hideDevBot = isDevBot && (!viewerUid || u?.privateTo !== viewerUid);
+        if (hideDevBot) {
...
+        }}>
+          <div style={{ width:'min(560px, 95vw)', maxHeight:'90vh', overflow:'auto',
